...
func RegisterEvhubProducerServer(s *grpc.Server, srv EvhubProducerServer) {
	s.RegisterService(&_EvhubProducer_serviceDesc, srv)
}
...
var _EvhubProducer_serviceDesc = grpc.ServiceDesc{
