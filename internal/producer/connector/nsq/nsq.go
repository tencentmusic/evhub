...
func (s *Nsq) SendDelayMsg(ctx context.Context, topic string, orderingKey string, data []byte, delay time.Duration) error {
...
func (s *Nsq) SendMsg(ctx context.Context, topic string, orderingKey string, data []byte) error {
